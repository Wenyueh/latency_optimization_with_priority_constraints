...
def update_cache_loading_or_recomputation_time_and_extra_saving_time(args, user_request):
    print('***start updating preemption***')
    print('user_request.user_request_id', user_request.user_request_id)
    print('user_request.remaining_computation_time', user_request.remaining_computation_time)
    print('user_request.predicted_remaining_computation_time', user_request.predicted_remaining_computation_time)
