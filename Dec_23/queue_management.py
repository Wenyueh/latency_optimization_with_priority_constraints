...
class Request:
    def __init__(self, args, user_request_id, computed_priority_value, computed_output_length_bucket_value):
        ...
        self.optimal_prefill_cache_proportion = max(0,(1-(self.args.cache_loading_speed/(2*self.args.prefill_speed)))) # with respect to prompt length
...
class PriorityQueue:
    ...
    def find_max_unsorted_node_idx(self):
        assert self.first_unsorted_node_idx == -1
