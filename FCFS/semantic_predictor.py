...
def priority_by_arrival(args, time_arrived_requests):
    priorities = {}
    for incoming_batch_order, incoming_batch in enumerate(time_arrived_requests):
        print('incoming_batch_order', incoming_batch)
        for user_request_id in incoming_batch:
            priorities[user_request_id] = incoming_batch_order
