...
def simulated_output_length_bucket_predictor(args, output_length_buckets):
    ...
    for mistaken_user_request_id in mistaken_user_request_ids:
        ...
        possible1  = min(args.ranks, max(1, config.user_request_priority[mistaken_user_request_id] + length_bucket_error_distance))
        possible2 = min(args.ranks, max(1, config.user_request_priority[mistaken_user_request_id] -length_bucket_error_distance))
